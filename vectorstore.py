...
class FaissVectorStore:
    def __init__(self, persist_dir: str = "faiss_store", embedding_model: str = "azure/genailab-maas-text-embedding-3-large", chunk_size: int = 1000, chunk_overlap: int = 200):
...
if __name__ == "__main__":
    ...
    store.load()
    # print(store.query("What is summary of susan_christopher?", top_k=3))